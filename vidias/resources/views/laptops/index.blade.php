...
<div id="head_display">
    ...
    <h1><em>Performance Delivered </em></h1>
    <h4>
        Still rubbing your fingers on the keyboard of an old desktop. 
    </h4> 
    <h4>
        Now is the time to grab a sleek laptop.
    </h4> 
    <h2></h2>                  
</div>
...
<div id="list_display">
    ...
    <div id="laptop_{{ $laptop->id }}">
        ...
        <p class="laptop_description"><?= e(substr(($laptop->laptop_description), 0, 60)) ?>...</p>
        <p><strong>Screen Size:</strong> {{ $laptop->screen_size }}" </p>
        <p><strong>Screen Resolution:</strong> {{ $laptop->screen_resolution }} ppi </p>
        <p><strong>Ram:</strong> {{ $laptop->ram->ram_size }} </p>
        <p><strong>Processor:</strong> {{ $laptop->processor->processor_name }} </p>
        <p><strong>Graphics:</strong> {{ $laptop->graphicscard->graphicscard_name }} </p>
