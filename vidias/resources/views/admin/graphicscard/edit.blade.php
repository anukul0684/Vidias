...
<div id="head_display" class="admin_background">
    <h1 class="admin_h1"><em>Edit Graphicscard</em></h1>
  ...
  <div class="row">
      <div class="col border" style="color:#fff; font-size:16px;"> 
          ...
          <form name="laptop_add" 
                id="laptop_add" 
                action="/admin/graphicscards/edit/{{$graphicscard->id}}"
                method="post"
                role="form"
                autocomplete="on"
                novalidate >
            ...
            <div class="form-group">
              ...
              value="{{ old('graphicscard_name',$graphicscard->graphicscard_name) ?? '' }}">
            ...
            <div class="form-group">
              ...
              value="{{ old('graphicscard_price',$graphicscard->graphicscard_price) ?? '' }}">
            ...
            <fieldset class="form-group">
              <?php $graphicscard_active = $graphicscard->active; ?>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="active" value="yes" 
                   {{old('active',$graphicscard_active)=='yes'?'checked':''}}> 
                 Yes
                </label>
              </div>
              <div class="form-check">
              <label class="form-check-label">
                  ...
                  {{old('active',$graphicscard_active)=='no'?'checked':''}}>       
                  No
                </label>
              </div>
            </fieldset>
